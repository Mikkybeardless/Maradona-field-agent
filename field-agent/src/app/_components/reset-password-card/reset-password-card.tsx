	...
	return (
		<section className='space-y-3'>
			...
			<div className={styles.card}>
				...
				<button type='button' className='text-orange w-full p-4 rounded-md border border-orange bg-white font-medium text-sm mb-4'>
					Verify using Whatsapp
				</button>
				<button type='button' className='text-orange w-full p-4 rounded-md border border-orange bg-white font-medium text-sm'>
					Send SMS
				</button>
			</div>
