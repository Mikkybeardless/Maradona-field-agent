      ...
      <div className={styles.card}>
        <form>
          ...
          <div className="space-y-1 relative mb-7">
            <label htmlFor="password" className='font-work-sans'>Password</label>
            <input type="password" id="password" name="password" className='w-full p-4 border border-[#ccc] rounded-md' placeholder="Password" />
            <button type='button' className='absolute right-4 top-10'>
            ...
            <div className='w-full grid place-items-end'>
              <button className='w-fit ml-auto text-[#5C4D58]'>Forgot password?</button>
            </div>
          </div>

          <button type="submit" className='bg-orange w-full p-4 rounded-md text-white font-medium'>Login</button>
        </form>
      </div>
    </section>
  )
