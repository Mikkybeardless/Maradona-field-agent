...
import CheckImage from "@/app/_assets/icons/Check.svg"; // Adjust the path as necessary
  ...
  return (
    ...
    >
      <div className="bg-white space-y-11 p-6 rounded-lg shadow-lg w-[300px] flex items-center justify-center max-w-[700px]">
        <Image src={CheckImage} width={50} height={50} alt="check image" />
        <h5 className="font-semibold">Inspection Approved</h5>
        <p>Property with request ID 1938409 has been approved for sale</p>
        <Link
