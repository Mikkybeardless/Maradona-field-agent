...
import authService, { SignUpData } from "@/app/api/services/auth.service";
...
export const SignUpCard = () => {
  ...
  return (
    <section className="space-y-3 mb-20 font-medium">
      <Image
        src={logo}
        width={265}
        height={103}
      ...
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-lg">
        <form onSubmit={handleSubmit}>
          <div className="space-y-1 mb-5">
            <label htmlFor="full_name" className="font-work-sans">
              Full Name
            </label>
            <input
              type="text"
          ...
          <div className="space-y-1 mb-5">
            <CustomDateInput label="Date of birth" value={null} />
          </div>
          <div className="space-y-1 mb-5">
            <label htmlFor="phone" className="font-work-sans">
              Phone no
            </label>
            <div className="relative border  border-[#ccc] rounded-md">
              <PhoneInput
                name="phone"
                inputStyle={{
                  width: "100%",
